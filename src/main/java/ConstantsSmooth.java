public class ConstantsSmooth {
    ...
    static String topic1p0lag = "http://prometheus-operated:9090/api/v1/query?query=" +
            "avg_over_time(kafka_consumergroup_lag%7Bconsumergroup=%22testgroup1%22,topic=%22testtopic1%22,partition=%220%22,namespace=%22default%22%7D%5B20s%5D)";
    static String topic1p1lag = "http://prometheus-operated:9090/api/v1/query?query=" +
            "avg_over_time(kafka_consumergroup_lag%7Bconsumergroup=%22testgroup1%22,topic=%22testtopic1%22,partition=%221%22,namespace=%22default%22%7D%5B20s%5D)";
    static String topic1p2lag = "http://prometheus-operated:9090/api/v1/query?query=" +
            "avg_over_time(kafka_consumergroup_lag%7Bconsumergroup=%22testgroup1%22,topic=%22testtopic1%22,partition=%222%22,namespace=%22default%22%7D%5B20s%5D)";
    static String topic1p3lag = "http://prometheus-operated:9090/api/v1/query?query=" +
            "avg_over_time(kafka_consumergroup_lag%7Bconsumergroup=%22testgroup1%22,topic=%22testtopic1%22,partition=%223%22,namespace=%22default%22%7D%5B20s%5D)";
    static String topic1p4lag = "http://prometheus-operated:9090/api/v1/query?query=" +
            "avg_over_time(kafka_consumergroup_lag%7Bconsumergroup=%22testgroup1%22,topic=%22testtopic1%22,partition=%224%22,namespace=%22default%22%7D%5B20s%5D)";
